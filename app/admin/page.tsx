              ...
              <div>
                ...
                <div className="relative mb-1.5">
                  <button
                    ...
                    className="w-full px-3 py-2 pr-9 text-left text-xs text-slate-600 bg-white border border-slate-200 rounded-xl"
                  ...
                  {sizesOpen && (
                    <button
                      ...
                      className="absolute right-1 top-1 rounded-lg p-1 text-slate-500 hover:bg-slate-100"
                      aria-label="Close preset sizes"
                    >
                ...
                <div className="relative mb-1.5">
                  ...
                  {colorsOpen && (
                    <button
                      ...
                      className="absolute right-1 top-1 rounded-lg p-1 text-slate-500 hover:bg-slate-100"
                      aria-label="Close preset colors"
                    >
                      <X className="h-3.5 w-3.5" />
                    </button>
                  )}
                        ...
                        <input
                          ...
                          onChange={() =>
                            setSelectedColors((current) =>
                              current.includes(clr)
                                ? current.filter((value) => value !== clr)
                                : [...current, clr],
                            )
                          }
                        />
